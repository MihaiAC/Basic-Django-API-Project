...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        new_user = create_user(email="new_user@example.com", password="testpass234")
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            "description": "New recipe descsription",
    ...
    def test_recipe_other_users_recipe(self):
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        # Only different statement from the previous test. DRY?
